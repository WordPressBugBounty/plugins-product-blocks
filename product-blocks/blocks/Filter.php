...
class Filter {
	...
	public function get_term_data( $args ) {
		...
		$filter = function ( $clauses, $taxonomies, $args ) use ( $product_ids, $taxonomy ) {
		...
		$total_terms = 0;
		$terms       = array();
		if ( $term_query['object_ids'] != 'wopb_empty' ) {
